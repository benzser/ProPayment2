...
public class CategoryExpenseAdapter extends CursorAdapter {

    ImageView cateicon;
    private TextView cate;

    public CategoryExpenseAdapter(Context context, Cursor cursor) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String sname = cursor.getString(cursor.getColumnIndex(myDBclass.EXPENSECATE_NAME));
        String sicon = cursor.getString(cursor.getColumnIndex(myDBclass.EXPENSECATE_ICON));
        String sstatus = cursor.getString(cursor.getColumnIndex(myDBclass.EXPENSECATE_STATUS));
    ...
    public void checkimage(String image){
        switch (image) {
            ...
            default:
                cateicon.setBackgroundResource(R.drawable.ic_other);
                break;
        }
    }
}