...
public class IncomePayment extends ActionBarActivity {


    private EditText edit_date, edit_amount, edit_des, cate_income;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_income_payment);
    ...
    private void bindListener() {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (recicon.equalsIgnoreCase("")) {
                    ...
                    Toast.makeText(getApplication(), "Income Added", Toast.LENGTH_LONG).show();


                    //String arrData[] = mydb.SelectDailyID("1");
                    mydb.InsertData(null, damount, "true", des, recname, recicon, date[0], date[1], date[2]);
                    edit_amount.setText("");
                    edit_des.setText("");
                    cate_income.setText("");
                    recicon="";
        ...
        imagecategory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), IncomeCate.class);
    ...
    private void bindWidget() {
        ...
        imagecategory = (ImageView) findViewById(R.id.image_cateincome);


        //Button
        confirm = (Button) findViewById(R.id.Confirm_Income);
        back = (Button) findViewById(R.id.Back_Income);

        //Edit Text
        cate_income = (EditText) findViewById(R.id.select_cateincome);
        edit_amount = (EditText) findViewById(R.id.edit_amount_income_payment);
        edit_amount.addTextChangedListener(new DecimalInputTextWatcher(edit_amount, 2));
        edit_des = (EditText) findViewById(R.id.edit_des_income_payment);
        ...
        //Calendar
        edit_date = (EditText) findViewById(R.id.edit_date_income_payment);
        edit_date.setText(daynow[0] + "/" + daynow[1] + "/" + daynow[2]);
        calendar_button = (ImageButton) findViewById(R.id.Calendar_income_payment);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_income_payment, menu);
        return true;
    }
