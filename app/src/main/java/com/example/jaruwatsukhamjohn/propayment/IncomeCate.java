...
public class IncomeCate extends ActionBarActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_income_cate);
        this.setTitle("Income Category");
        bindwidget();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_income_cate, menu);
        return true;
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        String sname = iCursor.getString(iCursor.getColumnIndex(myDBclass.INCATE_NAME));
        String sicon = iCursor.getString(iCursor.getColumnIndex(myDBclass.INCATE_ICON));
